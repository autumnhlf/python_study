...
var IU9L = function(i8a, t8l) {
    try {
        ...
        return {}.toString.call(i8a).toLowerCase() == "[object " + t8l + "]"
    } catch (e) {
        return !1
    }
};
var gX0x = function(i8a) {
        return IU9L(i8a, "function")
    }
var bg9X = function(k8c, cF9w, O9F) {
    if (!k8c || !k8c.length || !gX0x(cF9w))
        return this;
    if (!!k8c.forEach) {
        k8c.forEach(cF9w, O9F);
        return this
    }
    for (var i = 0, l = k8c.length; i < l; i++)
        cF9w.call(O9F, k8c[i], i, k8c);
    return this
}
var bvh7a = function(chL9C) {
        var m8e = [];
        bg9X(chL9C, function(chK9B) {
            m8e.push(emj[chK9B])
        });
        return m8e.join("")
    };
...
var CryptoJS = require("crypto-js")
    function b(a, b) {
        //CryptoJS 是公开的第三方库 可以通过nodejs安装  npm install crypto-js
